...
interface StandardEmptyStateProps {
  ...
  onAction?: () => void;
  showSpinner?: boolean;
  suggestions?: Array<{ label: string; action: () => void; icon?: string }>;
}
    ...
    >
      ...
      {description && (
        <Text
          ...
          style={{
            textAlign: 'center',
            marginBottom: actionLabel || suggestions.length > 0 ? SPACING.lg : 0, // Increased from 24 to SPACING.lg (24dp) for consistency
